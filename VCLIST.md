...
|'operator' : 'identifier1' indirection to slightly different base types from 'identifier2'|[/W4 C4057](https://docs.microsoft.com/ja-jp/cpp/error-messages/compiler-warnings/compiler-warning-level-4-c4057?view=vs-2019) [C][]|||
